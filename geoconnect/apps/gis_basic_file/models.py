...
'''
class xGISDataFile(TimeStampedModel):
    ...
    datafile_label = models.CharField('file name', max_length=255, blank=True)    # for display; filemetadata.label   (dvobject.id = filemetadata.datafile_id)
