...
class RegisteredDataverseParseTest(TestCase):
    ...
    def setUp(self):
        fixtures = ['registered_dv_test_data.json']
        print 'loaded...'
    ...
    def test_url_checks(self):
        ...
        #-------------------------------------------------
        self.assertEqual(RegisteredDataverse.objects.count(), 2, "Should be 2 RegisteredDataverse objects")
        ...
        #-------------------------------------------------
        self.find_existing_registered_dv('https://dvn-build.hmdc.harvard.edu')
        self.find_existing_registered_dv('https://dvn-build.hmdc.harvard.edu/dataset.xhtml?globalId=doi:10.5072/FK2/R0KKEJ&versionId=33')
        self.find_existing_registered_dv('https://dvn-BUILD.HMDC.HArvard.edu/dataset.xhtml?globalId=doi:10.5072/FK2/R0KKEJ&versionId=33')
        self.find_existing_registered_dv('Https://Dvn-Build.Hmdc.Harvard.Edu/Dataset.Xhtml?Globalid=Doi:10.5072/Fk2/R0Kkej&Versionid=33')
        self.find_existing_registered_dv('HTTPS://DATAVERSE-DEMO.IQ.HARVARD.EDU/MY-MY-MY')
        rd = self.find_existing_registered_dv('https://dvn-build.hmdc.harvard.edu/?//id=what&a=mess?3globalId=doi:10.5072/FK2/R0KKEJ&versionId=33')
        ...
        rd.active = False
        rd.save()
        rd2 = find_registered_dataverse('https://dvn-build.hmdc.harvard.edu')
        ...
        self.fail_to_find_existing_registered_dv('dvn-build.hmdc.harvard.edu')
        self.fail_to_find_existing_registered_dv('http://dvn-build.hmdc.harvard.edu')   # not https
