...
urlpatterns = patterns('gc_apps.gis_tabular.views',
...
urlpatterns += patterns('gc_apps.gis_tabular.views_create_layer',
...
urlpatterns += patterns('gc_apps.gis_tabular.views_delete',
